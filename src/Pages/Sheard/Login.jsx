    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4 sm:p-6">
            <div className="w-full max-w-md">
                ...
                <div className="mt-6 bg-gradient-to-r from-amber-900/20 to-amber-800/10 border border-amber-700/30 rounded-xl p-4">
                    <p className="text-sm text-center text-amber-300">
                        💡 <span className="font-medium">Demo Access:</span> Use admin credentials provided by your administrator
                    </p>
                </div>
